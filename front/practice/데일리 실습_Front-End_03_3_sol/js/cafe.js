...
function login() {
  ...
  // 지역 메뉴 선택 시 전체 펼치기/접기 구현, 각 지역 별 펼치기/접기 구현


  function allSlide( onoff ) { // 전체 펼치기

    console.log(onoff)
    if(onoff == 'on'){
        let seoul = document.querySelector("#seoul").style.display = "";
        let daejeon = document.querySelector("#daejeon").style.display = "";
        let gumi = document.querySelector("#gumi").style.display = "";
        let gwangju = document.querySelector("#gwangju").style.display = "";

        document.querySelector(".store_display_on").style.display = "none";
        document.querySelector(".store_display_off").style.display = "";
 
    }
    else {
        let seoul = document.querySelector("#seoul").style.display = "none";
        let daejeon = document.querySelector("#daejeon").style.display = "none";
        let gumi = document.querySelector("#gumi").style.display = "none";
        let gwangju = document.querySelector("#gwangju").style.display = "none";

        document.querySelector(".store_display_on").style.display = "";
  ...
  function slideDown( location ) { // 각 지역 별 펼치기
    if(location.style.display == ""){

        if(location == seoul){
            document.querySelector("#seoul").style.display="none";
        }
        if(location == daejeon){
            document.querySelector("#daejeon").style.display="none";
        }
        if(location == gumi){
            document.querySelector("#gumi").style.display="none";
        }
        if(location == gwangju){
            document.querySelector("#gwangju").style.display="none";
        }
        ...
        if(location == seoul){
            document.querySelector("#seoul").style.display="";
        }
        if(location == daejeon){
            document.querySelector("#daejeon").style.display="";
        }
        if(location == gumi){
            document.querySelector("#gumi").style.display="";
        }
        if(location == gwangju){
            document.querySelector("#gwangju").style.display="";
        }
  ...
  // 로그인 후 이전 페이지의 관리자 메뉴 클릭시 팝업창 열기
