  ...
  <body>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="clearfix align-content-center">
                ...
                />
                <p>
                  <span class="fw-bold"><%= rs.getString("user_id") %></span> <br />
                  <span class="text-secondary fw-light"> <%= rs.getString("register_time") %> 조회 : <%= rs.getInt("hit") %> </span>
                </p>
              </div>
            </div>
    ...
    <script>
      document.querySelector("#btn-list").addEventListener("click", function () {
        location.href = "/board2_js/board/list.jsp";
      });
